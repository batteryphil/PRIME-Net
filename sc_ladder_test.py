...
import time
import csv
from prime_sc_optimizer import run_prime_numba

if __name__ == "__main__":
    print("================================================================================")
    print(" PRIME ARCHITECTURE: SUBTREE CROSSOVER LADDER TEST (PRIME-SC)")
    print("================================================================================\n")
    ...
    with open('sc_ladder_results.csv', 'w', newline='') as f:
        writer = csv.writer(f)
    ...
    print("\nLadder complete! Data saved to sc_ladder_results.csv")
